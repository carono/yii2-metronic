...
/**
 * Demo9 layout — sticky header с верхней навигацией без sidebar.
 * Применяется для админок где требуется полная ширина рабочего пространства.
 *
...
use carono\metronic\widgets\TopNav;
